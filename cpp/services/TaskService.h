...
public:
    ...
    Q_INVOKABLE bool createTask(const QString& title, const QString& description, int priority = 0, const QString& dueAt = "", const QStringList& tags = QStringList(), const QString& listName = "Inbox");
    ...
    Q_INVOKABLE bool createList(const QString& listName, const QString& color = "", const QString& folderName = "", const QString& listType = "Task List");
    Q_INVOKABLE QStringList getFolders();
    Q_INVOKABLE bool createFolder(const QString& folderName);
    Q_INVOKABLE QStringList getTags();
    Q_INVOKABLE bool createTag(const QString& tagName, const QString& color = "", const QString& parentTag = "");
