...
public:
    ...
    Q_INVOKABLE void addTask(const QString& title, const QString& description, int priority = 0, const QString& dueAt = "", const QStringList& tags = QStringList(), const QString& listName = "Inbox");
    ...
    Q_INVOKABLE void createList(const QString& listName, const QString& color = "", const QString& folderName = "", const QString& listType = "Task List");
    Q_INVOKABLE void createFolder(const QString& folderName);
    Q_INVOKABLE void createTag(const QString& tagName, const QString& color = "", const QString& parentTag = "");
    ...
    Q_PROPERTY(QString activeFilterList READ activeFilterList NOTIFY filterChanged)
    ...
    Q_PROPERTY(QString selectedTaskList READ selectedTaskList NOTIFY selectedTaskChanged)
